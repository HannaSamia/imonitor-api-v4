...
export class QbeController {
  ...
  save(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  run(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  pie(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  doughnut(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  trend(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  verticalBar(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  horizontalBar(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  progress(@Body() dto: any, @CurrentUser('id') userId: string) {
  ...
  explodedProgress(@Body() dto: any, @CurrentUser('id') userId: string) {
